                ...
                <main class="site-main col-sm-12 col-md-12 flex-first">
                    <div class="room-wrapper">
                        <div class="room_gallery clearfix">
                            ...
                            <asp:ListView ID="lstViewImageSlider" runat="server">
                                <ItemTemplate>
                                    <div class="slider-container">
                                        <div class="slider-wrapper">
                                            <img src="<%# ResolveUrl(Eval("URL").ToString()) %>" alt="ảnh Phòng Gia Đình" class="slider-image w-100" style="height: 450px">
                                        </div>
                        ...
                        <asp:ListView ID="lstViewRoomDetails" runat="server">
                            <ItemTemplate>
                                ...
                                <a href="/Website/Cart.aspx?id=<%# Eval("id") %>" class="btn btn-secondary cart mb-2 float-right" style="height: 57px;">Thêm Vào Giỏ Hàng</a>
                            </ItemTemplate>
                        </asp:ListView>
                    </div>
                </main>

                <div id="secondary" class="widget-area col-sm-12 col-md-12 col-lg-12 sticky-sidebar">
                    <div class="wd wd-book-room">
                        <a href="#" class="book-room bookingroom float-right" style="border-radius: 4px;">Đặt Phòng Ngay</a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    <script>
        document.getElementById('<%= txtNumOfPeople.ClientID %>').addEventListener('input', function () {
