<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ImportExportDetail.aspx.cs" Inherits="hotel.Admin.ImportExportDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content1" runat="server">
    ...
    <div class="container py-2">
        <div id="form_data" visible="false" runat="server" class="content_crud bdlayout" >
            <h2>
                <asp:Label ID="txth2" ForeColor="White" Font-Bold="true" Visible="true" runat="server" Text="Thêm Thông Tin Nhập Xuất Sản Phẩm"></asp:Label>
            </h2>
            <div class="position-relative" style="padding: 0px 15px;">
                <div class="formedit">
                    ...
                    <div class="formedit_div">
                        <div class="formedit_lable">Số Lượng Hàng</div>
                        <asp:TextBox ID="txtstquantity" runat="server" CssClass="crud_iput"></asp:TextBox>
                    </div>

                    <div class="formedit_div">
                        <div class="formedit_lable">Type</div>
                        <asp:DropDownList ID="txtinout" CssClass="selc w-100" runat="server">
                            <asp:ListItem Text="Chọn Việc Làm" Value="" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Nhập" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Xuất" Value="2"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="formedit_div">
        ...
        <div id="list_data" runat="server" class="content_cruds bdlayout">
            <h3 class="position-relative">Danh sách chi tiết hàng hóa
            ...
            <div class="table-responsive text-nowrap " style="padding-bottom: 35px;">
                ...
                <asp:ListView ID="lstViewImportDetails" OnItemCommand="lstViewImportDetails_ItemCommand" runat="server">
                    <LayoutTemplate>
                        <table id="tblEmpDetails">
                            <thead>
                                <tr class="altRow">
                                    ...
                                    <th class="rb"><b>Tên Mặt Hàng</b></th>
                                    <th class="rb" width="60px"><b>Việc Làm</b></th>
                                    <th class="rb" width="60px"><b>Số lượng Hàng</b></th>
                    ...
                    <ItemTemplate>
                        <tr class='<%# (Container.DataItemIndex + 1) % 2 == 0 ? "altrow" : "normalrow" %>'>
                            ...
                            <td class="trb"><%# Eval("w_name") %></td>
                            <td class="trb"><%# Eval("s_name") %></td>
                            <td class="trb"><%# 
                            Eval("type") != DBNull.Value && int.TryParse(Eval("type").ToString(), out int typeValue) 
                            ? (typeValue == 1 ? "Nhập" : (typeValue == 2 ? "Xuất" : "Chưa cập nhật")) 
                            : "Chưa cập nhật" 
                            %>
                            </td>
