...
<head runat="server">
    ...
    <style>
        ...
        .container__bgImg {
            background-image: url(https://www.cnn.com/interactive/2020/08/sport/lionel-messi-career-barcelona-spt-intl/media/images/card.jpg);
            background-size: cover;
            background-repeat: no-repeat;
            background-position: center;
        }

            .container__bgImg::before {
                content: "";
                position: absolute;
                top: 0;
                left: 0;
