...
namespace hotel.Admin
{
    public partial class EmployeeAccount : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //======= Insert Query.
            string cmdText = "INSERT INTO account ( username, password, role, active,  created_by, created_when, last_update_by, last_update_when, employee_id , customer_id) VALUES ( @username, @password, @role, @active,  @created_by, @created_when, @last_update_by, @last_update_when, @employee_id, @customer_id)";
            ...
            cmd.Parameters.AddWithValue("@customer_id", string.IsNullOrEmpty(txtcustomer.SelectedValue) ? (object)DBNull.Value : txtcustomer.SelectedValue);
        ...
        void bindAcountDetailsToListView(string searchName)
        {
            ...
            //======= Select Query.
            string cmdText = "SELECT a.id ,a.username ,a.password ,a.role ,a.active as active ,cm.id , cm.name as tenkhachhang, a.created_by, e.id as idnv ,a.created_when ,a.last_update_by ,a.last_update_when ,a.employee_id,  a.customer_id ,e.name as name FROM account a left join employee e on e.id = a.employee_id left join contact_management cm on cm.id = a.customer_id";
        ...
        public void bindAccountDetailToEdit(int id)
        {
            ...
            if (dr.HasRows)
            {
                ...
                txtcustomer.SelectedValue = dr["customer_id"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            //======= Update Query.
            string cmdText = "UPDATE account SET username=@username, password= @password, role=@role, active=@active,   last_update_by=@last_update_by, last_update_when=@last_update_when, employee_id= @employee_id , customer_id= @customer_id WHERE id=@id";
