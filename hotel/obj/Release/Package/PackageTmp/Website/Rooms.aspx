    ...
    <div id="main-content">
        ...
        <div class="site-content container">
            <div class="rooms-content layout-grid style-02">
                <div class="row">
                    <h5 class="clearfix col-12">Tìm Kiếm Phòng</h5>
                    <div class="clearfix col-12">
                        <asp:TextBox ID="SearchName" runat="server" TextMode="Number" MaxLength="5" placeholder="Nhập số lượng người(Phòng chỉ tối đa 5 người) ......" CssClass="roomsearch" />
                        <asp:DropDownList ID="SearchRoomType" runat="server" CssClass="selectsrc"></asp:DropDownList>
                        <asp:LinkButton ID="btnSearchr" runat="server" CssClass=" btn btn-primary btnsearchroom" Text="Search" OnClick="btnSearch_Click"><i class="fas fa-search"></i></asp:LinkButton>
                    </div>
                    <span id="errorMsg" style="color: red; display: none;padding-left: 16px;" class="clearfix mb-3">Số lượng người chỉ tối đa là 5.</span>

                </div>
                <div class="row" id="roomContainer">
                    <asp:ListView ID="lstViewRoomDetails" runat="server">
                        <ItemTemplate>
                            <div class="room col-sm-4 clearfix pb-4 " style="height: 561px;" data-page="1">
                                <div class="room-item" style="height: 100%;">
                                    ...
                                    <div class="room-summary">
                                        ...
                                        <ul class="room-info">
                                            <li><b>Số giường:</b> <%# Eval("num_bed") %></li>
                                            <li><span class="separator"></span></li>
                                            <li><b>Diện Tích:</b> <%# Eval("dientich") %> m<sup>2</sup></li>
                                        </ul>
                                        <div class="line"></div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    <script type="text/javascript">
        document.getElementById('<%= SearchName.ClientID %>').addEventListener('input', function () {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const roomsPerPage = 9;  // Number of rooms displayed per page
