<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="imgRoom.aspx.cs" Inherits="hotel.Admin.imgRoom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content1" runat="server">
    ...
    <div class="container py-2">
        <div id="form_data" visible="false" runat="server" class="content_crud bdlayout">
            <h2>
                <asp:Label ID="txth2" ForeColor="White" Font-Bold="true" Visible="true" runat="server" Text="Thêm Ảnh Của Các Phòng"></asp:Label>
            </h2>
            <div style="display: flex; gap: 1.6rem !important; align-items: center; margin: 20px;">
                ...
                <div>
                    <asp:FileUpload ID="FileUploadImage" runat="server" multiple="multiple" CssClass="" />
                </div>
            </div>
            ...
            <div class="position-relative" style="padding: 0px 15px;">
                <div class="formedit">
                    ...
                    <div class="formedit_div">
                        <div class="formedit_lable">Ảnh Đại Diện </div>
                        <div class="stast">
                            <asp:CheckBox ID="txtatvImg" runat="server" />
                        </div>
                    </div>
                    <div class="formedit_div">
        ...
        <div id="list_data" runat="server" class="content_cruds bdlayout">
            <h3 class="position-relative"> Ảnh Của Phòng
            ...
            <div class="search">
                <p>Tìm kiếm Loại tài liệu ảnh các phòng: </p>
                ...
                <asp:DropDownList ID="SearchRoom" runat="server" CssClass="selc"></asp:DropDownList>
                ...
                <asp:ListView ID="lstViewDocumentDetails" OnItemCommand="lstViewDocumentDetails_ItemCommand" runat="server">
                        ...
                        <table id="tblEmpDetails">
                            <thead>
                                <tr class="altRow">
                                    ...
                                    <th class="rb" width="30px"><b>Ảnh Đại Diện </b></th>
                    ...
                    <ItemTemplate>
                        <tr class='<%# (Container.DataItemIndex + 1) % 2 == 0 ? "altrow" : "normalrow" %>'>
                            ...
                            <td class="trb"><%# (Eval("activeImg") != DBNull.Value && Convert.ToBoolean(Eval("activeImg")))?"<i style='color:green' class='fa fa-check' ></i>":"<i style='color:red'  class='fa fa-times'></i>" %></td>
