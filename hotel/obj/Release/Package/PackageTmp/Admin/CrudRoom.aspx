    ...
    <div class="container py-2">
        <div id="form_data" visible="false" runat="server" class="content_crud bdlayout">
            ...
            <div style="display: flex; gap: 1.6rem !important; align-items: center; margin: 20px;">
                ...
                <img id="imgProfile" visible="false" runat="server" src="~/App_Themes/Admin_Pages/Layout/assets/img/avatars/avt.png" class="imguser" />
                <a id="newImg" class="newImg" runat="server" visible="false">Chỉnh Sửa Ảnh</a>
                <div id="imagePreview" class="d-flex flex-wrap" runat="server">
                </div>
            </div>
