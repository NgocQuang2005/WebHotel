...
<asp:Content ID="Content2" ContentPlaceHolderID="Content1" runat="server">
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            initializeQuill('quillEditor', '<%= txtmt.ClientID %>');
        });
        ...
        <div id="form_data" visible="false" runat="server" class="content_crud bdlayout" >
            ...
            <div class="position-relative" style="padding: 0px 15px;">
                <div class="formedit">
                    ...
                    <div class="formedit_div">
                        <div class="formedit_lable">Cccd hoặc Cmnd*</div>
                        <asp:TextBox ID="txtndphone" runat="server" placeholder=" ..." CssClass="crud_iput"></asp:TextBox>
                    </div>
                    <div class="formedit_div">
