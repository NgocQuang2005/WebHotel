<%@ Page Title="" Language="C#" MasterPageFile="~/Website/Websitehotel.Master" AutoEventWireup="true" CodeBehind="Room.aspx.cs" Inherits="hotel.Website.SingleRoom" %>
        ...
        <div class="page-title">
            <div class="page-title-wrapper" data-stellar-background-ratio="0.5">
                <div class="content container">
                    <h3 class="heading_primary">Loại Phòng</h3>
                    <ul class="breadcrumbs">
                        <li class="item"><a href="Home.aspx">Trang Chủ</a></li>
                        <li class="item"><span class="separator"></span></li>
                        <li class="item active">Loại Phòng </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="rooms-content layout-grid style-02">
                <div class="row" id="roomContainer">
                    ...
                    <asp:ListView ID="lstViewEmployeeDetails" runat="server">
                        <ItemTemplate>
                            <div class="room col-sm-4 clearfix pb-4 " data-page="1">
                                <div class="room-item">
                                    <div class="room-media">
                                        <a href="<%# "Rooms.aspx?room_type_id=" + Eval("id").ToString() %>">
                                            <img src='<%# ResolveUrl(Eval("URL").ToString()) %>' class="imgphong w-100" alt=""></a>
                                    </div>
                                    <div class="room-summary">
                                        <h3 class="room-title">
                                            <a href="<%# "Rooms.aspx?room_type_id=" + Eval("id").ToString() %>"><%# Eval("name") %></a>
                                        </h3>
                                        <ul class="room-info">
                                            <li><%# Eval("description") %></li>
                                            <li><span class="separator"></span></li>
                                            <li>Quantity: <%# Eval("quantity") %></li>
                                        </ul>
                                        <div class="line"></div>
